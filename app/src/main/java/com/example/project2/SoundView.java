...
public class SoundView extends View {
    ...
    private com.example.project2.SoundProgressChangeListner soundProgressChangeListner;

    public int getMaxprogess() {
        return maxprogess;
    }
    public void setOnsoundProgressChangeListner(com.example.project2.SoundProgressChangeListner soundProgressChangeListner){
